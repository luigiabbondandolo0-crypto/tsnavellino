...
export default function Footer() {
  return (
    <footer className="bg-[#0C0A09]" role="contentinfo">
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-10">
        <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="sm:col-span-2">
            <div className="mb-5">
              <div
                className="text-white font-bold text-2xl tracking-widest leading-none"
                style={{ fontFamily: "var(--font-display)" }}
              >
                T.S.N.
              </div>
              <div className="text-[11px] tracking-[0.3em] text-[#57534E] uppercase mt-1 font-medium">
                Avellino · Est. 1892
              </div>
            </div>
            <p className="text-[#57534E] text-sm leading-relaxed max-w-xs mb-6">
              Tiro a Segno Nazionale, sezione di Avellino.
              Dal 1892 la precisione è arte.
            </p>
            <div className="space-y-1.5 text-sm">
              <div className="flex items-start gap-2.5 text-[#3A3632]">
              ...
              <div className="flex items-center gap-2.5 text-[#3A3632]">
          ...
          <nav aria-label="Footer navigation">
            <p className="text-[#3A3632] text-[10px] tracking-[0.3em] uppercase mb-5 font-medium">
              Navigazione
            </p>
            <ul className="space-y-3" role="list">
              {navLinks.map((l) => (
                <li key={l.href}>
                  <Link
                    href={l.href}
                    className="text-[#57534E] text-sm hover:text-[#CA8A04] transition-colors duration-200 flex items-center gap-2 group"
                  >
              ...
              {downloads.map((d) => (
                <li key={d.label}>
                  <a
                    ...
                    className="flex items-center gap-2 text-[#57534E] text-sm hover:text-[#CA8A04] transition-colors duration-200 group"
                  >
        ...
        {/* Divider + bottom bar */}
        <div className="pt-8 border-t border-[#1C1917] flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="h-px w-12 bg-[#CA8A04]/30" />
          </div>
        </div>
      </div>
    </footer>
